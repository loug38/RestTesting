...
<module external.linked.project.id=":react-native-fcm" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" external.system.module.group="RestTesting" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
